      ...
      <section className="relative mx-auto max-w-6xl border-x border-hairline">
        ...
        <div className="grid gap-6 p-6 sm:grid-cols-2">
          {interactions
            ...
            >
              {/* interaction window */}
              <div className={`relative flex items-center justify-center overflow-hidden rounded-xl bg-background px-10 ${slug === "transform-flow" ? "aspect-[32/11] px-0" : "aspect-[4/3]"}`}>
                {CardComponent ? (
                  <CardComponent />
                ) : StageComponent ? (
                  <StageComponent />
