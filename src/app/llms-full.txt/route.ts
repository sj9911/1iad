// llms-full.txt — full index + inlined source for AI agents and vibe coders.
// The slim index at /llms.txt links here; this file grows with every new day.
...
export async function GET() {
  ...
  const body = [
    "# 1IAD — One Interaction A Day (full source)",
