...
const cardComponents: Record<string, ComponentType> = {
  ...
  "transform-flow": function TransformFlowCard() {
    return <div className="absolute inset-0 flex items-center"><TransformFlow className="w-full rounded-none border-0 shadow-none" aspectRatio="32 / 14.3" assetSize={72} duration={15} particleCount={0} sound={false} interactive /></div>;
  },
};
